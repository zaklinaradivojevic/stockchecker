  ...
  test("Viewing one stock", function (done) {
    chai
      ...
      .end(function (err, res) {
        ...
        // If stockData is an array, assert its properties
        if (Array.isArray(res.body.stockData)) {
          ...
          // If stockData is an object, assert its properties directly
    ...
    chai
      ...
      .end(function (err, res) {
        ...
        if (Array.isArray(res.body.stockData)) {
          ...
          assert.property(res.body.stockData, "price");
          assert.property(res.body.stockData, "likes");
          assert.isAbove(res.body.stockData.likes, 0); // Assuming liking increases the likes count
        }
